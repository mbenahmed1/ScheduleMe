...
\begin{frame}
	\frametitle{ScheduleMe - Vergleich Nachbarschaften}
		...
		\begin{columns}[c]
			\column{.25\textwidth}
				\includegraphics[width=\textwidth]{../images/results_swap.pdf}	
			\column{.25\textwidth}
				\includegraphics[width=\textwidth]{../images/results_api.pdf}	
			\column{.25\textwidth}
				\includegraphics[width=\textwidth]{../images/results_shift.pdf}	
			\column{.25\textwidth}
				\includegraphics[width=\textwidth]{../images/results_random.pdf}	
		\end{columns}
